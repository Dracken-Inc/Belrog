        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-t border-sf-dark-700 px-4 py-3">
          <p className="min-w-0 flex-1 text-[11px] leading-relaxed text-sf-text-muted">
            {t(
              ...
              undefined,
              'Thumbnails are provided by YouTube. Belrog loads the player only after you choose to watch a video.',
            )}
          </p>
          <button
            type="button"
...
function SubmissionModal({ onClose }) {
  ...
  const handleSubmit = async (event) => {
    ...
    const message = [
      ...
      'Permission for Belrog to feature the work: Yes',
    ].join('\n')
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-1 text-xs leading-relaxed text-sf-text-muted">
              {t(
                ...
                undefined,
                'Share a YouTube video made with Belrog. Every submission is reviewed before anything is featured.',
              )}
            </p>
          </div>
          <button
        ...
        {sent ? (
            ...
            <div role="status" aria-live="polite">
              ...
              <p className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-sf-text-muted">
                {t(
                  ...
                  undefined,
                  'Thank you. The Belrog team will review your submission; it will not be published automatically.',
                )}
              </p>
            </div>
          ...
          <form className="overflow-y-auto px-5 py-4" onSubmit={handleSubmit}>
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <label className="sm:col-span-2">
                <span className="mb-1.5 block text-xs font-medium text-sf-text-secondary">
                  {t('discover.submit.description', undefined, 'How did you use Belrog?')}
                </span>
                <textarea
                  required
                  rows={4}
                  ...
                  placeholder={t(
                    ...
                    undefined,
                    'Tell us briefly which parts of the project you made or edited in Belrog.',
                  )}
            ...
            <div className="mt-4 space-y-3 rounded-xl border border-sf-dark-700 bg-sf-dark-950/55 p-3.5">
              ...
              <label className="flex cursor-pointer items-start gap-2.5 text-xs leading-relaxed text-sf-text-secondary">
                ...
                <span>{t(
                  ...
                  undefined,
                  'Belrog may feature the video title, thumbnail, link, description, and creator attribution.',
                )}</span>
              </label>
            </div>
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 max-w-2xl text-xs leading-relaxed text-sf-text-muted">
              {t(
                'discover.subtitle',
                undefined,
                'See what creators make with Belrog and learn the workflows behind it.',
              )}
            </p>
