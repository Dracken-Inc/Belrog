 ...
 *
 * Ownership: outputs use a `Belrog_music_` filename prefix, which matches
 * comfyAutoImport's Belrog_MANAGED_OUTPUT_RE, and every queued prompt id is
 ...
 * 'Belrog-music-jobs-updated' window event.
 */
...
export const MUSIC_JOBS_UPDATED_EVENT = 'Belrog-music-jobs-updated'
...
export function buildAceStepWorkflow({
  ...
  return {
    ...
    107: {
      ...
      inputs: {
        filename_prefix: 'audio/Belrog_music_ace',
        quality: 'V0',
        audioUI: '',
        audio: ['18', 0],
      },
