...
export const useProjectStore = create(
  persist(
    (set, get) => ({
      ...
      // When false (default), Belrog lands on the project picker so
      ...
      initialize: async () => {
        ...
        try {
          ...
          // By default Belrog lands on the project picker instead.
      ...
      /**
       * Toggle whether Belrog should reopen the last project on
