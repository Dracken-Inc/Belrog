...
- **Desktop app:** for most users who just want to install belrog and use it.
...
The desktop app includes belrog and its built-in workflow definitions. It does **not** include ComfyUI itself.
...
5. Return to belrog and use `Generate`
...
3. Open `belrog > Getting Started` from the bottom menu.
