...
- A ComfyUI-importable copy of the workflow graph bundled with belrog.
...
4. Add your Comfy account API key in belrog Settings before queueing.
5. Return to belrog Generate and click `Re-check` before queueing.
