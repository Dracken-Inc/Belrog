...
When you run the workflow through belrog, generated assets are routed back into the project structure used by the app.
...
5. Return to belrog and use `Re-check` before queueing.
