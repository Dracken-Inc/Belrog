...
- a valid Comfy account API key in belrog
...
## belrog says a dependency is missing

Use the workflow inside ComfyUI first, then return to belrog and click `Re-check`. The starter pack is meant to help you close exactly that gap.
