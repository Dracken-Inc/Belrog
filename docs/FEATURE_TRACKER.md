...
- Editor hotkey presets also exist for belrog, Premiere-style, Resolve-style, and Final Cut-style bindings.
...
- belrog is getting faster for real editing, not just generation
