# belrog v0.1.4 Draft Release Notes
...
- New `MoGraph` workspace in beta for building transparent motion graphics assets inside belrog
...
- Added built-in keymap presets for `belrog`, `Premiere-style`, `Resolve-style`, and `Final Cut-style` bindings
...
- Added a draft marketing/release site under `site/belrog`

## Important Setup Note

belrog generation still depends on a separate local ComfyUI installation.
...
`belrog v0.1.4 - Editing polish and MoGraph workspace`
