# belrog v0.1.8 Draft Release Notes

## Choose The Right Download

- **Desktop app:** for most users who want to install belrog and use the editor, Generate workflows, the embedded ComfyUI tab, and export tools directly.
...
- The current captioning workflow in belrog still uses the ComfyUI/Qwen ASR path
...
`belrog v0.1.8 - Smaller app package with caption runtime cleanup`
