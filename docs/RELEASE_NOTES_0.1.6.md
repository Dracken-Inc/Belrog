# belrog v0.1.6 Draft Release Notes

## Choose The Right Download

- **Desktop app:** for most users who want to install belrog and use the editor, Generate workflows, and export tools directly.
...
- The packaged starter pack artifact is ready as:
  - `release/belrog-workflow-starter-pack-v0.1.6.zip`
...
`belrog v0.1.6 - Animated captions, kinetic typography, and subtitle controls`
