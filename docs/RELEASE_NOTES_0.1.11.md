# belrog v0.1.11 Draft Release Notes

## Choose The Right Download

- **Desktop app:** for most users who want to install belrog and use the editor, Generate workflows, Director Mode, Flow tools, and export features directly.
...
- Added Flow AI, a visual node-based workspace for chaining prompt, image, video, and audio steps inside belrog
...
`belrog v0.1.11 - Director Mode passes, proxy playback, and commit renders`
