# belrog v0.1.12 Draft Release Notes

## Choose The Right Download

- **Desktop app:** for most users who want to install belrog and use the editor, Generate workflows, Director Mode, Flow AI, and export features directly.
...
- Added in-app song transcription using the Qwen ASR caption workflow to generate cue-level SRT inside belrog
...
- Native Chromium focus rectangles on range sliders and buttons are now suppressed when interacting with the mouse, with a subtle belrog focus ring kept for keyboard Tab navigation
...
belrog generation still depends on a separate local ComfyUI installation in this build.
...
`belrog v0.1.12 - Timeline tools, effects stack, music video pipeline, and UX polish`
