# Belrog runtime guard (prestartup hook).
#
...
#
# Removal: delete this directory. Belrog will recreate it on the next
...
try:
    _banner = ("[Belrog runtime guard] installed: " + ", ".join(_patch_notes) + "\n").encode("ascii", "replace")
