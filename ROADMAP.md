...
belrog is evolving into an AI-native editing and generation environment built around ComfyUI.
...
belrog already includes a strong foundation that we want to keep improving:
...
belrog is not just an editor. It is also a generation environment. This phase focuses on expanding creative options inside the app.
...
One of the most exciting directions for belrog is turning it into a more complete system for music-driven creative output.
...
Beyond individual workflows, we want belrog to become a stronger creative system for structured generation and editing.
...
As belrog grows, we want to stay grounded in a few principles:
...
If you use belrog and have thoughts on editing, generation, or workflow design, feedback is always welcome.
