...
- The product/app is called Belrog. Do not refer to it as ComfyStudio in user-facing text, MCP metadata, docs, or chat.
...
- Belrog is a creator-facing desktop video editor. Preserve simple guided workflows; do not turn routine product surfaces into ComfyUI-style node configuration.
...
- Agent write actions should inspect first, preview when supported, and use Belrog's existing undo/checkpoint paths.
